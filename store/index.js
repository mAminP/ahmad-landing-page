export const state = () => ({
  ...
  topFeatures: {
    title: 'چرا هوبو شاپ ؟',
    paragraph: ' سیر صعودی و پیشرفت روز افزون کاربرد فناوری اطلاعات در دنیا همه ی حوزه ها را تحت تاثیر خود قرار داده و خرید و فروش هم ازاین قاعده مستثنی نیست ، امروزه هر فروشگاهی در تلاش برای به کارگیری ازاین فناوری در روند توسعه کسب وکار خود است. هوبوشاب نیز درامر تحقق همین امر بستری رافراهم کرده است تاهم فروشگاه ها بتوانند محصولات خود را در آن عرضه نمایند و هم مردم بتوانندبا حداقل زمان وکمترین هزینه از ویترین فروشگاه ها دیدن کنند و بهترین و مناسب ترین انتخاب و خرید خود را داشته باشند. هدف اصلی ما در ابتدا دیده شدن فروشگاه ها و صرفه جویی در وقت و هزینه ی مردم عزیز و گرانقدر است و در آینده ای نزدیک خرید و فروش نیز از طریق نرم افزار هوبو شاپ امکان پذیر خواهد بود ...',
    cards: [
      {
        title: 'سریع',
