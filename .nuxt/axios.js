...
export default (ctx, inject) => {
  ...
  const baseURL = process.browser
    ? (runtimeConfig.browserBaseURL || runtimeConfig.baseURL || 'https://hoboshopapi.ir/api/v1/')
      : (runtimeConfig.baseURL || process.env._AXIOS_BASE_URL_ || 'https://hoboshopapi.ir/api/v1/')
